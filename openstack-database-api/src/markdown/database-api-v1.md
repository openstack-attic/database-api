...
Unless otherwise documented, all resources provided by the Database API
...
`/v1/entities` which is not actually a part of the Database API, and is used
...
This status code is returned by the root database endpoint, with references to
...
#### Restart instance `POST /instances/{instance_id}/action`
...
#### Resize instance `POST /instances/{instance_id}/action`
...
#### Resize volume `POST /instances/{instance_id}/action`
